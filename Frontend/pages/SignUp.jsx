...
const SignIn = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center">
      <div className="border border-8 w-[60%] h-[60%] bg-[#d67c36] rounded-lg flex flex-col items-center justify-center">
        {currentState === "SignIn" ? (
          <form
            onSubmit={onSubmitHandler}
            className="w-[90%] h-[90%] bg-backgroundTan rounded-lg flex flex-col items-center"
          >
            <div className=" rounded-lg flex w-[50%] h-[10%] mt-[10%] justify-center items-center">
              <p className="font-['Holtwood_One_SC'] text-white text-5xl">Sign In</p>
            </div>
            {/* Email Input */}
            <input
              type="email"
            ...
            <div className="flex flex-row justify-between w-[80%] mt-[4%]">
              <Link
                to="/forgot-password"
                className="bg-white font-['Holtwood_One_SC'] rounded-lg px-2 py-1 text-[#F97316] text-xs cursor-pointer"
              >
                Forgot Password?
              </Link>
              <button
                ...
                className="bg-white rounded-lg px-2 py-1 text-[#F97316] text-xs cursor-pointer"
              >
                <p className="font-['Holtwood_One_SC']">
                Continue
                </p>
              </button>
            </div>
            <div className="p-1.5 bg-blue-500 rounded-lg mt-[8%] cursor-pointer">
                <p
                className="text-white text-sm font-['Holtwood_One_SC']"
          ...
          >
            <div className="rounded-lg flex w-[100%] h-[10%] mt-[5%] justify-center items-center">
              <p className="text-white text-5xl font-['Holtwood_One_SC']">Create Account</p>
            </div>
            {/* Names Input */}
            <div className="flex flex-row w-[80%] h-[8%] mt-[6%] gap-x-3">
              <input
                type="name"
            ...
            <div className="font-['Holtwood_One_SC'] flex flex-row justify-between w-[80%] mt-[4%]">
              <Link
                to="/forgot-password"
                className="bg-white rounded-lg px-2 py-1 text-[#F97316] text-xs cursor-pointer"
              >
            ...
            <div className="font-['Holtwood_One_SC'] mt-[4%] px-2 py-1 bg-blue-500 rounded-lg cursor-pointer">
                <p
